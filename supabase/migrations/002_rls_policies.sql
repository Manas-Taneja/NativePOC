...
-- Messages policies
CREATE POLICY "Users can view messages in their organization's channels"
...
CREATE POLICY "Users can insert messages in their organization's channels"
...
CREATE POLICY "Users can create insights in their organization"
